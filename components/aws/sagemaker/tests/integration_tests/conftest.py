...
def deploy_endpoint(sagemaker_client, s3_data_bucket, sagemaker_role_arn, region):
    model_name = utils.generate_random_string(5) + "-model"
    endpoint_name = utils.generate_random_string(5) + "-endpoint-v2"
    endpoint_config_name = utils.generate_random_string(5) + "-endpoint-config"
