...
class SageMakerDataQualityJobDefinitionSpec(
    SageMakerComponentSpec[SageMakerDataQualityJobDefinitionInputs, SageMakerDataQualityJobDefinitionOutputs]
):
    ...
    def __init__(self, arguments: List[str]):
        super().__init__(arguments, SageMakerDataQualityJobDefinitionInputs, SageMakerDataQualityJobDefinitionOutputs)
